            ...
            {isApplyJobLoading?<PageLoading />:<>
                {applyJob?<>
                        ...
                        extra={
                            me?.type==="ADMIN"?<>
                                    <Button
                                        ...
                                        onClick={()=>{approval("PASSED");}}
                                        disabled={applyJob.state!=="APPLYING"}
                                    >通过</Button>
                                    <Button
                                        loading={isApprovalApplyJobLoading}
                                        onClick={()=>{approval("NOT_PASSED");}}
                                        disabled={applyJob.state!=="APPLYING"}
                                    >拒绝</Button>
                            </>:
                            <>
                    ...
                    >
                        ...
                        <Descriptions.Item label="申请时间">{new Date(applyJob.createdTime).toLocaleDateString()}</Descriptions.Item>
                        ...
                        {applyJob.operateUser?<>
                            ...
                            <Descriptions.Item label="操作时间">{new Date(applyJob.operateTime).toLocaleDateString()}</Descriptions.Item>
                        </>:<></>}

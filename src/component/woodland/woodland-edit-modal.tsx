...
export const WoodlandEditModal = ({
                                      woodlandId,
                                      visible,
                                      setVisible
                                  }: {
    ...
    useEffect(() => {
        setPosition({...position, ...woodland?.position});
        setAddress(woodland?.address||address);
    },[woodland]);
    ...
    const {mutateAsync: editWoodland, isLoading: isEditWoodlandLoading} = useEditWoodland();

    const handleSubmit = async (value: EditWoodlandRequestParams) => {
        try {
            await editWoodland({...value, woodlandId})
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <Form.Item>
                        <Button type="primary" htmlType="submit" loading={isEditWoodlandLoading} >
                            修改信息
                        </Button>
                    </Form.Item>
                </Form>
